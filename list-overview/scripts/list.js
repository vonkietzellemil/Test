...
function createRowElement(rowData, list, mode) {
  ...
  row.innerHTML = `
    ...
    <div class="counter-btn-container">
      ...
      <button class="counter-plus-btn" type="button"><img class="counter-btn-icon" src="images/plus.svg"></button>
      <button class="counter-minus-btn" type="button"><img class="counter-btn-icon" src="images/minus.svg"></button>
    </div>
  `;
